 ...
 */
public class pr6 extends javax.swing.JFrame {
    DefaultTableModel modelo;
    /**
     * Creates new form pr6
     */
    public pr6() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(pr6.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
