...
public class ListarCuentas extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Las cuentas registradas son las siguientes</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h2>El resultado es " + listaCuentas + "</h2>");
            out.println("<br>");
            out.println("<form action=\"consultarCuenta\" method=\"post\">");
            out.println("<table border=\"1\" align=\"center\">");
            out.println("<tr>");
            out.println("<td>Digite el numero de cuenta que quiere consultar</td>");
