 ...
 */
@WebServlet(name = "enviarPalabraRetiro", urlPatterns = {"/enviarPalabraRetiro"})
public class EnviarPalabraRetiro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<br>");
            out.println("<form action=\"realizarRetiro\" method=\"post\">");
            ...
            out.println("</tr>");
            out.println("<tr>");
            out.println("<td colspan=\"2\" align=\"center\"><input type=\"submit\" value=\"enviar palabra\"/></td>");
            out.println("</tr>");
            out.println("</table>");
            out.println("</form>");
            out.println("</body>");
